...
import { getCoffeeProducts } from '@/lib/coffee';
...
export default async function CoffeePage({
  ...
  const coffeeProducts = getCoffeeProducts(products, categories);
    ...
    <div className="pb-8">
      ...
      <div className="mt-6">
        {coffeeProducts.length === 0 ? (
          ...
          <CoffeeMenuBoard products={coffeeProducts} locale={locale as Locale} />
        )}
      </div>
    </div>
  );
