...
const messages = {
  tr: {
    ...
    productsHint: 'Fiyat ve stok adedini yazın → Kaydet. Menüdeki değerler buradan güncellenir.',
  ...
  ru: {
    ...
    productsHint: 'Введите цену и остаток → Сохранить. На сайте отображаются эти значения.',
