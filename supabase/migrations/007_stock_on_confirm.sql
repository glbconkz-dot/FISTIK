-- FISTIK — Stok sadece admin "Confirmed" yapınca düşer (WhatsApp açılışında değil)
-- Supabase SQL Editor'de bir kez çalıştırın (006'dan sonra).

ALTER TABLE orders
  ADD COLUMN IF NOT EXISTS stock_deducted boolean NOT NULL DEFAULT false;

-- Checkout: sadece kontrol, stok düşürmez
...
BEGIN
  ...
  LOOP
    UPDATE products
    SET stock_quantity = stock_quantity - COALESCE((item->>'quantity')::integer, 0)
...
BEGIN
  ...
  IF NOT FOUND OR NOT o.stock_deducted THEN
    RETURN;
  END IF;
