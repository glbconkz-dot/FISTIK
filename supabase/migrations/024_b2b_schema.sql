...
-- ========================
-- B2B BRANCHES (delivery addresses)
-- ========================
...
-- ========================
-- B2B PRODUCT PRICES (separate from B2C)
-- ========================
...
-- ========================
-- B2B MONTHLY STATS (paid totals → next month discount)
-- ========================
...
-- ========================
-- RLS — server-only (service role); no public policies
-- ========================
