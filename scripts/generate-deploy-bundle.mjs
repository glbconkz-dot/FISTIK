...
// B2C müşteri sipariş hattı (şimdilik Kaskelen)
env.NEXT_PUBLIC_WHATSAPP_NUMBER = '77782681755';
env.NEXT_PUBLIC_B2C_ORDER_BRANCH = env.NEXT_PUBLIC_B2C_ORDER_BRANCH || 'kaskelen';
// B2B sipariş hattı (ayrı)
env.NEXT_PUBLIC_B2B_WHATSAPP_NUMBER = '77010995573';
...
const vercelKeys = [
  ...
  'NEXT_PUBLIC_B2B_WHATSAPP_NUMBER',
  'NEXT_PUBLIC_B2C_ORDER_BRANCH',
